...
interface PaymentNewCardFormProps {
  onCancel: () => void;
}

export default function PaymentNewCardForm({ onCancel }: PaymentNewCardFormProps) {
  const [isOpen, setIsOpen] = useState<(EventTarget & HTMLButtonElement) | null>(null);
