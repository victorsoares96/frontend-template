import { Button, ButtonProps, Popover, Theme } from '@mui/material';
import { alpha, styled } from '@mui/material/styles';

import { NAVBAR } from '../../../config';

interface ListItemStyleProps extends ButtonProps {
  activeRoot: boolean;
  activeSub: boolean;
  subItem: boolean;
  open: boolean;
...
})(({ activeRoot, activeSub, subItem, open, theme }: ListItemStyleProps) => {
